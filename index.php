          ...
          <div class="col-lg-6 pt-4 pt-lg-0 order-2 order-lg-1 content" data-aos="fade-right" data-aos-delay="100">
            ...
            <ul>
              <li><i class="ri-check-double-line"></i> Cyber Security is an applied science that focuses
                ...
                made possible. </li>
              <li><i class="ri-check-double-line"></i>Cyber Security is considered as much of an art as a science by the
                practitioners
                that provide consulting, engineering, and IT security services that reduce risk for businesses and
                government..</li>
              <li><i class="ri-check-double-line"></i>Cyber Security controls can be used as safeguards to reduce risk
                for businesses and government..</li>
            </ul>
            <p>
              Cyber Security measures protect organizations from systems and infrastructure attacks by malicious
